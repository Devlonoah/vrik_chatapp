...
List<User> usersList = [
  User(name: 'Christina Kennedy'),
  User(name: 'Mary James'),
  User(name: 'Frederick Anthony'),
  User(name: 'Samuel Logan'),
  User(name: 'Wolf Smith')
];
...
final List<Post> posts = [
  ...
  Post(
      ...
      comments: 201,
      shares: 27,
      userThatLikedPost: [onlineUsers[6], onlineUsers[1]]),
  Post(
      user: onlineUsers[3],
      caption: 'Adventure 🏔',
      timeAgo: '15hr',
